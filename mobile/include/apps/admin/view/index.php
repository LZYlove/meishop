...
<title>{$lang['cp_home']} - Powered by TIANXIAKE</title>
...
<div id="admin_header">
  ...
  <div id="submenu-div">
    <ul>
      ...
      <li><a href="http://www.tianxiake.com" target="_blank">{$lang['help']}</a></li>
...
<div id="admin_bottom" style="text-align:center; line-height:30px">Copyright &copy; <?php echo date('Y');?> 广东天下客电子商务有限公司. All Rights Reserved.</div>
