...
function get_page_title($cat = 0, $str = '') {
    /* 初始化“页面标题”和“当前位置” */
    $page_title = C('shop_title') . ' - ' . 'Powered by TIANXIAKE';
...
function license_info() {
    if (C('licensed') > 0) {
        $license = '<a href="http://www.tianxiake.com/license.php?product=ectouch_free&url=' . urlencode(__URL__) . '" target="_blank"
>&nbsp;&nbsp;Licensed</a>';
        return $license;
    } else {
        return '';
