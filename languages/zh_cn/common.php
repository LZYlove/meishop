 ...
 * TIANXIAKE 前台语言文件
 * ============================================================================
 * * 版权所有 2015 广东天下客电子商务有限公司，并保留所有权利。
 * 网站地址: http://www.tianxiake.com；
 * ----------------------------------------------------------------------------
 * 这不是一个自由软件！您只能在不用于商业目的的前提下对程序代码进行修改和
 * 使用；不允许对程序代码以任何形式任何目的的再发布。
 * ============================================================================
 * $Author: lorend $
 * $Id: common.php 17217 2011-01-19 06:29:08Z lorend $
*/
...
$_LANG['p_y']['link_start'] = '<a href="http://www.tianxiake.com" target="_blank" style=" font-family:Verdana; font-size:11px;">';
