...
border-top: #D1CD1F 1px solid;width:100%; color:#FFF; line-height: 42px; text-align:left;}
...
.ico_1{background:#B3A114   url(images/menu_1.png) 9px  center no-repeat ;}
.ico_2{background:#B3A114   url(images/menu_2.png) 9px  center no-repeat ;}
.ico_3{background:#B3A114   url(images/menu_3.png) 9px  center no-repeat ;}
.ico_4{background:#B3A114   url(images/menu_4.png) 9px  center no-repeat ;}
.ico_5{background:#B3A114   url(images/menu_5.png) 9px  center no-repeat ;}
.ico_6{background:#B3A114   url(images/menu_6.png) 9px  center no-repeat ;}
.ico_7{background:#B3A114   url(images/menu_7.png) 9px  center no-repeat ;}
.ico_8{background:#B3A114   url(images/menu_8.png) 9px  center no-repeat ;}
.ico_9{background:#B3A114   url(images/menu_9.png) 9px  center no-repeat ;}
.ico_10{background:#B3A114   url(images/menu_10.png) 9px  center no-repeat ;}
.ico_11{background:#B3A114   url(images/menu_11.png) 9px  center no-repeat ;}
.ico_12{background:#B3A114   url(images/menu_12.png) 9px  center no-repeat ;}
.ico_13{background:#B3A114   url(images/menu_13.png) 9px  center no-repeat ;}
.ico_14{background:#B3A114   url(images/menu_14.png) 9px  center no-repeat ;}
.ico_15{background:#B3A114   url(images/menu_15.png) 9px  center no-repeat ;}
.ico_16{background:#B3A114   url(images/menu_16.png) 9px  center no-repeat ;}


.ico2_1{background:#B3A114   url(images/menu1_1.png) 9px  0px no-repeat ;}
.ico2_2{background:#B3A114   url(images/menu1_2.png) 9px  0px no-repeat ;}
.ico2_3{background:#B3A114   url(images/menu1_3.png) 9px  0px no-repeat ;}
.ico2_4{background:#B3A114   url(images/menu1_4.png) 9px  0px no-repeat ;}
.ico2_5{background:#B3A114   url(images/menu1_5.png) 9px  0px no-repeat ;}
.ico2_6{background:#B3A114   url(images/menu1_6.png) 9px  0px no-repeat ;}
.ico2_7{background:#B3A114   url(images/menu1_7.png) 9px  0px no-repeat ;}
.ico2_8{background:#B3A114   url(images/menu1_8.png) 9px  0px no-repeat ;}
.ico2_9{background:#B3A114   url(images/menu1_9.png) 9px  0px no-repeat ;}
.ico2_10{background:#B3A114   url(images/menu1_10.png) 9px  0px no-repeat ;}
.ico2_11{background:#B3A114   url(images/menu1_11.png) 9px  0px no-repeat ;}
.ico2_12{background:#B3A114   url(images/menu1_12.png) 9px  0px no-repeat ;}
.ico2_13{background:#B3A114   url(images/menu1_13.png) 9px  0px no-repeat ;}
.ico2_14{background:#B3A114   url(images/menu1_14.png) 9px  0px no-repeat ;}
.ico2_15{background:#B3A114   url(images/menu1_15.png) 9px  0px no-repeat ;}
.ico2_16{background:#B3A114   url(images/menu1_16.png) 9px  0px no-repeat ;}
...
line-height: 30px;
display: block; }
.menu-item a:hover{background-color:#e8e8e8; text-decoration:none;}
#help-title {
  font-size: 14px;
  color: #000080;
  margin: 5px 0;
