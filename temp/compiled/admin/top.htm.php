...
#header-div {
  background: #1BD4D5;
  border-bottom: 1px solid #11C9C8; height:83px;
}
...
#submenu-div li {
  ...
  width: 82px;
  height: 82px;
  border-left: 1px solid #27E7E5;
  border-right: 1px solid #07BAAC;
}
#submenu-div li a {
  text-align: center;
  height: 74px;
...
.muneFG {
  height: 13px;
  width: 0px;
  border-right: 1px solid #D915E3;
  margin-top: 15px;
*margin-top:-18px;
  _margin-top: 0px;
  border-left: 1px solid #840481;
...
#menu-div ul li:hover ul li {
  border-bottom: 1px solid #9C8411;
  border-top: #D1CD1F 1px solid;
}
...
<body>
  <div id="header-div">
    <div id="logo-div" style="bgcolor:#000000;">
      <img src="images/topLogo.jpg" alt="TIANXIAKE shop" />
    </div>
    <div id="license-div" style="bgcolor:#000000;"></div>
    <div id="submenu-div">
      <ul>
        <li>
          <a href="privilege.php?act=logout" target="main-frame">
            <img src="images/topmune_08.png" style="border:none;"/>
            <span><?php echo $this->_var['lang']['signout']; ?></span>
          </a>
        </li>
        <li>
          <a href="index.php?act=clear_cache" target="main-frame" class="fix-submenu">
            <img src="images/qingchu.png" style="border:none;"/>
            <span><?php echo $this->_var['lang']['clear_cache']; ?></span>
          </a>
        </li>
        <li>
          <a href="../mobile" target="_blank">
            <img src="images/topmune_07.png" style="border:none;"/>
            <span><?php echo $this->_var['lang']['about']; ?></span>
          </a>
        </li>

        <li>
          <a href="javascript:web_address();">
            <img src="images/topmune_007.png" style="border:none;"/>
            <span><?php echo $this->_var['lang']['help']; ?></span>
          </a>
        </li>
        <li>
          <a href="../" target="_blank">
            <img src="images/topmune_06.png" style="border:none;"/>
            <span><?php echo $this->_var['lang']['preview']; ?></span>
          </a>
        </li>
        <li>
          <a href="message.php?act=list" target="main-frame">
            <img src="images/topmune_05.png" style="border:none;"/>
            <span><?php echo $this->_var['lang']['view_message']; ?></span>
          </a>
        </li>
        <li>
          <a href="privilege.php?act=modif" target="main-frame">
            <img src="images/topmune_04.png" style="border:none;"/>
            <span><?php echo $this->_var['lang']['profile']; ?></span>
          </a>
        </li>
        <li>
          <a href="javascript:window.top.frames['main-frame'].document.location.reload();window.top.frames['header-frame'].document.location.reload()">
            <img src="images/topmune_03.png" style="border:none;"/>
            <span><?php echo $this->_var['lang']['refresh']; ?></span>
          </a>
        </li>
        <li>
          <a href="#"  onclick="ShowToDoList()">
            <img src="images/topmune_02.png" style="border:none;"/>
            <span><?php echo $this->_var['lang']['todolist']; ?></span>
          </a>
        </li>

        <li style="">
          <a href="index.php?act=first" target="main-frame">
            <img src="images/topmune_01.png" style="border:none;"/>
            <span><?php echo $this->_var['lang']['shop_guide']; ?></span>
          </a>
        </li>
        <!-- <li style="width:102px;border-left:none;">
          <a href="http://www.ecmoban.com" target="main-frame" style="color:#ff0; width:102px; font-weight:bold;">
            <img src="images/topmune_09.png" style="border:none;"/>
            <span>更多模板堂产品</span>
          </a>
        </li> -->
      </ul>
      <div id="send_info" style="padding: 5px 10px 0 0; clear:right;text-align: right; color: #FF9900;width:40%;float: right;  display:none;">
        ...
        <span id="send_msg">
          <img src="images/top_loader.gif" width="16" height="16" alt="<?php echo $this->_var['lang']['loading']; ?>" style="vertical-align: middle" />
          <?php echo $this->_var['lang']['email_sending']; ?>
        </span>
    ...
    sprintf = sprintfWrapper.init;  
      ...
      <div id="load-div" style="padding: 5px 10px 0 0; text-align: right; color: #FF9900; display: none;width:40%;float:right;">
        <img src="images/top_loader.gif" width="16" height="16" alt="<?php echo $this->_var['lang']['loading']; ?>" style="vertical-align: middle" />
        <?php echo $this->_var['lang']['loading']; ?>
      </div>
    </div>
  </div>
  <div id="menu-div">
    <ul>
      ...
      <li style="border-left:none;">
        <a href="index.php?act=main" target="main-frame">
          <img src="images/index-11_07.png" width="17" height="18" style="border:none;" align="absmiddle"/>
          <span><?php echo $this->_var['lang']['admin_home']; ?></span>
        </a>
      ...
      <li>
        <a href="privilege.php?act=modif" target="main-frame">
          <img src="images/index-11_41.png" width="17" height="18" align="absmiddle"/>
          <span><?php echo $this->_var['lang']['set_navigator']; ?></span>
        </a>
        <span class="muneFG"></span>
      </li>
      <li>
        <a href="goods.php?act=list" target="main-frame">
          <img src="images/index-11_09.png" width="17" height="18" align="absmiddle"/>
          <span>商品管理</span>
          <span class="num"><?php echo $this->_var['goods_sum']; ?></span>
        </a>
        <span class="muneFG"></span>
      </li>
      <li>
        <a href="order.php?act=list" target="main-frame">
          <img src="images/dd.png" width="15" height="18" align="absmiddle"/>
          <span>订单管理</span>
          <span class="num"><?php echo $this->_var['order_sum']; ?></span>
        </a>
        <span class="muneFG"></span>
      </li>
      <li>
        <a href="ads.php?act=list" target="main-frame">
          <img src="images/index-11_13.png" width="17" height="20" align="absmiddle"/>
          <span>广告管理</span>
          <span class="num"><?php echo $this->_var['ad_sum']; ?></span>
        </a>
        <span class="muneFG"></span>
      </li>
      <li>
        <a href="comment_manage.php?act=list" target="main-frame">
          <img src="images/index-11_19.png" width="17" height="18" align="absmiddle"/>
          <span>用户评论</span>
          <span class="num"><?php echo $this->_var['comment_sum']; ?></span>
        </a>
        <span class="muneFG"></span>
      </li>
...
?>
      <li>
        <a href="<?php echo $this->_var['key']; ?>" target="main-frame"><?php echo $this->_var['item']; ?></a>
      </li>
